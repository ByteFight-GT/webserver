 ...
 *
 * Each TournamentMatch (series) contains multiple TournamentGame records.
 * This DTO exposes the game number, the underlying GameMatch UUID (for
 * linking to game logs/replays), and the result status of that game.
 */
@Getter
@Builder
