...
public class PublicGameMatchFileController {
  ...
  @Operation(operationId = "getPublicGameMatchFile", summary = "Get a public game match file")
  public ResponseEntity<GameMatchFileDto> getPublicGameMatchFile(
      @PathVariable UUID matchUuid, @PathVariable String slug) {
