...
public class AuthService {
  ...
  public AuthService(HttpClient http, ObjectMapper om, AuthProperties props) {
    ...
    this.readTimeout =
        Duration.ofMillis(props.readTimeoutMs() == null ? 5000 : props.readTimeoutMs());
  }

  public SupabaseDtos.SupabaseUser createUser(
      String email,
      String password,
    ...
    var body =
        new SupabaseDtos.CreateUserRequest(
            email, password, emailConfirmed, userMetadata, appMetadata);
