...
public class DevAdminUserRunner implements ApplicationRunner {
    ...
    public DevAdminUserRunner(DevAdminUserProperties properties, UserRepository userRepository, UserService userService) {
    ...
    public void run(ApplicationArguments args) {
        if (isBlank(properties.getEmail()) || isBlank(properties.getPassword()) || isBlank(properties.getUsername())) {
