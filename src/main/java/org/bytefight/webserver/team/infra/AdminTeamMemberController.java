...
import org.bytefight.webserver.player.domain.AdminPlayerDto;
...
public class AdminTeamMemberController {
    ...
    public AdminTeamMemberController(AdminTeamService adminTeamService, PlayerRepository playerRepository) {
    ...
    @Operation(
            ...
            summary = "REST endpoint to list team members"
    )
