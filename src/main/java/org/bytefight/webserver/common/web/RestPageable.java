...
public final class RestPageable {
  ...
  public static Pageable fromRestParams(
      ...
      int maxPageSize,
      String defaultSortField) {
    return fromRestParams(
        page, perPage, sort, order, defaultPageSize, maxPageSize, defaultSortField, Set.of());
  }

  private static String normalizeSortField(
      String sort, String defaultSortField, Set<String> allowedSortFields) {
